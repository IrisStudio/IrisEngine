...
#ifndef FLATBUFFERS_GENERATED_MONSTERMANAGER_H_
#define FLATBUFFERS_GENERATED_MONSTERMANAGER_H_
...
struct MonsterManager FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  enum {
    VT_MONSTERS = 4
  };
  const flatbuffers::Vector<flatbuffers::Offset<Monster>> *monsters() const { return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Monster>> *>(VT_MONSTERS); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<flatbuffers::uoffset_t>(verifier, VT_MONSTERS) &&
           verifier.Verify(monsters()) &&
           verifier.VerifyVectorOfTables(monsters()) &&
           verifier.EndTable();
  }
};

struct MonsterManagerBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_monsters(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Monster>>> monsters) { fbb_.AddOffset(MonsterManager::VT_MONSTERS, monsters); }
  MonsterManagerBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
  MonsterManagerBuilder &operator=(const MonsterManagerBuilder &);
  flatbuffers::Offset<MonsterManager> Finish() {
    auto o = flatbuffers::Offset<MonsterManager>(fbb_.EndTable(start_, 1));
    return o;
  }
};

inline flatbuffers::Offset<MonsterManager> CreateMonsterManager(flatbuffers::FlatBufferBuilder &_fbb,
   flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Monster>>> monsters = 0) {
  MonsterManagerBuilder builder_(_fbb);
...
inline const MonsterManager *GetMonsterManager(const void *buf) { return flatbuffers::GetRoot<MonsterManager>(buf); }

inline bool VerifyMonsterManagerBuffer(flatbuffers::Verifier &verifier) { return verifier.VerifyBuffer<MonsterManager>(); }

inline void FinishMonsterManagerBuffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<MonsterManager> root) { fbb.Finish(root); }


#endif  // FLATBUFFERS_GENERATED_MONSTERMANAGER_H_
