...
public:
  ...
  inline bool operator != ( const Vector3<T>& otro ) const;
  inline bool IsEqualEpsilon( const Vector3<T>& otro,
...
// FUNCIONES EXTERNAS
//////////////////////////////////////////////
template<typename T> inline Vector3<T> VectorMinComponents( const Vector3<T>& uno,
    const Vector3<T>& otro );
template<typename T> inline Vector3<T> VectorMaxComponents( const Vector3<T>& uno,
    const Vector3<T>& otro );
...
extern const Math::Vect3f  v3fUP;
