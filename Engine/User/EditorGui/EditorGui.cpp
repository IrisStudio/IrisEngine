...
static uint32       g_FontTexture = 0;
static int          g_ShaderHandle = 0, g_VertHandle = 0, g_FragHandle = 0;
static int          g_AttribLocationTex = 0, g_AttribLocationProjMtx = 0;
static int          g_AttribLocationPosition = 0, g_AttribLocationUV = 0, g_AttribLocationColor = 0;
static unsigned int g_VboHandle = 0, g_VaoHandle = 0, g_ElementsHandle = 0;

static CEffect* mEffect = nullptr;
static CGeometry* mGeometry = nullptr;
...
void ImGui_ImplGlfwGL3_RenderDrawLists(ImDrawData* draw_data)
{
	...
	*/
	...
	CState &lState = CState::Instance();

	lState.EnableBlend();
	lState.SetBlendEquation(eBE_Add);
	lState.SetBlendFunc(eBF_SRC_ALPHA, eBF_ONE_MINUS_SRC_ALPHA);
	lState.DisableCullFace();
	lState.DisableDepthTest();
	lState.EnableScissorTest();
